# 📦 Baldi's Powertoys
![Latest Release](https://img.shields.io/github/v/release/NekitTOP4IK/baldi-powertoys) ![Game Version](https://img.shields.io/badge/Игра-Baldi's_Basics_Plus_v0.13.X-blue)
...
11. **Skip Detention**
   Позволяет пропустить наказания от директора и сразу выйти из кабинета! Активация: **`END`**

12. **Quick Restock Store**
   Позволяет мгновенно (и бесплатно) обновить ассортимент магазина Джонни! Активация: **`R`**
...
✅ Поддержка **русского и английского** языков (так же возможность принудительно поставить английский язык)
